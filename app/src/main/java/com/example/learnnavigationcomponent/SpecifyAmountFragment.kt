...
class SpecifyAmountFragment : Fragment(), View.OnClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        inputAmount = view.findViewById<EditText>(R.id.input_amount)
    }
    ...
    override fun onClick(v: View) {
        ...
        when(v.id){
            R.id.send_btn -> {
                if(inputAmount.text.toString().isNotEmpty()){
                    ...
                    Log.d("Logesh sharma" ," Logesh ${navController.getBackStackEntry(R.id.mainFragment)}")
